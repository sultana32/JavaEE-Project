			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="span9"> 
						...
						<p> Eine Aktivierungsmail wurde an Ihren E-Mail-Account geschickt. Klicken Sie den Link an, um Ihren Account zu aktivieren. </p>
						 <br>
						<p> Vielen Dank, dass Sie mein Projekt testen.</p>
 					</div>
                </div>
			</div>
		</div>
