		...
		<div id="includescroll"></div>
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="span9"> 
						<p>Your email has been sent.Thanks you for your e-mail test. I am glad that you are testing my practice project. </p>
						<br>
						<p>I hope you will register in this site and test my database works as well.</p>
					 </div>
				</div>
			</div>
		</div>
