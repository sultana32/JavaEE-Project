				...
				<div class="span9">
					...
					<div id=register_box>
						<form action="mylogin" method="get">
							...
							<br /> <label for="pwd">Passwort:</label> <input type="password"
								id="pwd" name="pwd"> <input type="submit" name="submit"
								value="Login" />
						</form>
						<a href="/forgetId">Haben Sie Ihr Benutzername vergessen?</a> <br>
						<a href="/forgetPw?token=0">Haben Sie Ihr Passwort vergessen?</a>
					</div>
				</div>
