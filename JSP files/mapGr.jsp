		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="span9">
					...
					<p>Ich verwende Google Maps sehr oft, da ich es als sehr
						praktisch erachte. Daher wollte ich es in mein Praxis-Projekt
						integrieren und auf meine Art und Weise anpassen.</p>
					...
					<script type="text/javascript">
						...
						var map = new google.maps.Map(document
								...
								{
									zoom : 10,
									center : new google.maps.LatLng(47.378389,
											8.541430),
