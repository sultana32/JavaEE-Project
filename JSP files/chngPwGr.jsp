		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="span9">
					...
					<div id=register_box>
						<form action="mychngpw" method="get">



							<label for="pwd">Password:</label> <input type="password"
								id="pwd" name="pwd"> <label for="confirmpwd">Confirm
								Password:</label> <input type="password" id="confirmpwd"
								name="confirmpwd"> <input type="submit" name="submit"
								value="changePw" />
						</form>
					</div>
