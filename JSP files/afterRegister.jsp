			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="span9"> 
						 ...
						 <p> An activation email has been sent to your email account.You can click the link and activate your account.</p>
						 <br>
						<p> And Thank you for your kind attempt in testing my practice project.</p>
                	</div>
				</div>
			</div>
		</div>
